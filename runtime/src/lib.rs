...
impl pallet_balances::Trait for Runtime {
	...
	// TODO 类似  System 和 Event 这样标红的变量是通过怎么样的方式导入的？运行原理是什么？
...
impl template::Trait for Runtime {
	// TODO: 对应 pallets template 模块中 pub trait Trait: frame_system::Trait{} 参数变量
	...
	type MaxLength = MaxNickLength;
	// The ubiquitous event type.
	// TODO: 这里Event编译器报 红 是因为编辑器上下文没有找到这个，但是编译的时候却没有问题
	type Event = Event;
}
...
construct_runtime!(
	...
	{
		// TODO: 是不是在这里导入了 某个，pallets ，那么就可以引用 对应 system::Trait for Runtime 里面的参数 ：
		// TODO: system::Trait for Runtime { }
